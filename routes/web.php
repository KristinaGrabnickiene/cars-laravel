...
Route::get('/create', 'CarsController@save')->name('cars.create')->middleware(['auth','role']); 
Route::post('/store', 'CarsController@store')->name('cars.store');

//owner routs
Route::get('/owners', 'OwnersController@index')->name('owners.index'); 
Route::get('/owners/create', 'OwnersController@create')->name('owners.create')->middleware(['auth','role']); 
